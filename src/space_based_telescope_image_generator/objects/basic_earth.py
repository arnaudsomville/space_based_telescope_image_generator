...
from vapory import POVRayElement, BumpMap, Normal, Object, Sphere, Texture, Pigment, Finish, ImageMap, Union
...
class BasicEarth(POVRayElement):
    ...
    def _create_earth(self)->Object:
        ...
        earth_pigment = Pigment(
            ImageMap(
                "tiff", "\"/resources/images/earth_color_43K.tif\"",
    ...
    def _create_clouds(self)->Object:
        ...
        clouds_pigment = Pigment(
            ImageMap(
                "tiff", "\"/resources/images/earth_clouds_43K.tif\"",
                'map_type', 1, 'interpolate', 2,
                'transmit', 'all', 0.8
            )
        )
